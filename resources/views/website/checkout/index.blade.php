            ...
            <div class="col-md-6">
                <div class="mb-25">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email" readonly value="{{ $customer->email}}" required="" placeholder="Email Address">
                        @else
                    ...
                    <div class="form-group">
                        <textarea required="" type="text" name="delivery_address" placeholder="Delivery Address"></textarea>
                    </div>
            </div>
            <div class="col-md-6">
                    ...
                    <div class="table-responsive order_table text-center">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="image product-thumbnail"><img src="{{ asset($item->options->image)}}" alt="#" style="height: 60px"></td>
                                    <td>
                                ...
                                <tr>
                                    <th>SubTotal</th>
                                    <td class="product-subtotal" colspan="2">${{$sum}}.00</td>
                                </tr>
                                <tr>
                                    <th>Tax Amount</th>
                                    <td class="product-subtotal" colspan="2">${{$tax = round($sum*0.15)}}.00</td>
                                </tr>
                                <tr>
                                    <th>Shipping</th>
                                ...
                                <tr>
                                    <th>Total</th>
                                    <td colspan="2" class="product-subtotal"><span class="font-xl text-brand fw-900">${{$orderTotal=$sum+$tax+$shipping}}.00</span></td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="payment_method">
                        ...
                        <div class="payment_option">
                            <div class="custome-radio">
                                ...
                                <label class="form-check-label" for="exampleRadios3" data-bs-toggle="collapse" data-target="#bankTranfer" aria-controls="bankTranfer">Cash On Delivry</label>

                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="detail-gallery">
                                        ...
                                        <div class="product-image-slider">
                                            @foreach ($product->productImages as $productImage)
                                                <figure class="border-radius-10">
                                                    <img src="{{ asset($productImage->image) }}" alt="product image" style="height: 638px; width:546px">
                                                </figure>
                                            @endforeach
                                        </div>
                                        <!-- THUMBNAILS -->
                                        <div class="slider-nav-thumbnails pl-15 pr-15">
                                            @foreach ($product->productImages as $productImage)
                                                <div><img src="{{ asset($productImage->image) }}" alt="product image" style="height: 98px">
                                                </div>
                                            @endforeach
                                    ...
                                    <div class="detail-info">
                                        ...
                                        <div class="clearfix product-price-cover">
                                            <div class="product-price primary-color float-left">
                                                ...
                                                <ins><span
                                                        class="old-price font-md ml-15">${{ $product->regular_price }}.00</span></ins>
                                        ...
                                        <div class="attr-detail attr-size">
                                            ...
                                            <div class="mt-2">
                                                @foreach ($product->sizes as $key1 =>$size)
                                                        ...
                                                        <label><input type="radio" style="width: 20px; height:10px" name="size" {{ $key1 == 0 ? 'checked':''}} value="{{ $size->size->name }}" /> {{ $size->size->name }}</label>
                                        ...
                                        <ul class="product-meta font-xs color-grey mt-50">
                                            ...
                                            <li class="mb-5">Tags: <a href="#" rel="tag">Cloth</a>, <a
                                                    ...
                                                    rel="tag">Dress</a> </li>
                                            <li>Availability:<span class="in-stock text-success ml-5">{{ $product->stock_amount }} Items In
                                                    Stock</span></li>
                                        </ul>
                                    </div>
                                </form>
                                            ...
                                            <div class="product-cart-wrap small hover-up">
                                                <div class="product-img-action-wrap">
                                                    ...
                                                    <div class="product-action-1">
                                                        <a aria-label="Quick view" class="action-btn small hover-up"
                                                            data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="fi-rs-search"></i></a>
                                                ...
                                                <div class="product-content-wrap">
                                                    ...
                                                    <div class="product-price">
                                                        ...
                                                        <span class="old-price">${{$category_product->regular_price}}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

                ...
                <form action="{{ route('color.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row mb-4">
                        <label for="" class="col-md-3 form-label ">Color Code</label>
                                <div class="col-md-9">
                                    <input type="color" name="code" class="form-control border-0 p-0 wpx-80" value="#77bc21" placeholder="Color Code" />
                                </div>
                    </div>
                    <div class="row mb-4">
                        <label for="" class="col-md-3  form-label">Color Description</label>
                        <div class="col-md-9">
                            <textarea class="form-control mb-4" name="description" placeholder="Color Description" rows="3" ></textarea>
                        </div>
                    </div>
                    <div class="row mb-4">
                    ...
                    <div class="row">
                        <label for="" class="col-md-3"></label>
                            <div class="col-md-9">
                                <input type="submit" class="btn btn-success rounded-0" value="Create New Color">
                            </div>
                    </div>
                </form>
            </div>
